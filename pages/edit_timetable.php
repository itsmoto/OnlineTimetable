...
if(mysqli_num_rows($result_check)>0){
 $exec = mysqli_query($link,"SELECT * FROM program_and_course WHERE year_of_timetable='$year_of_timetable' AND drafts='$drafts' ");  
}else {
    header("location: listoftimetable.php");
}
}  else {
        ...
        <article>
            <div class="row">
                ...
                <div class="col-md-8">
                    <center>
                        <div class="bg-white">
                            <div class="timetable-head">MODIFY A NEW TIME TABLE</div>
                                ...
                                <div class=" form-group">
                                    <div class="col-md-6">
                                        <button class="btn btn-block btn-timetable" type="submit" name="btn-maketimetable">
                                            <i class="glyphicon glyphicon-time"></i> Modify TimeTable
                                        </button>
                                    </div>
                                    <div class="col-md-6">
