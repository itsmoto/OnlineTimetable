...
$error_msg = '';
           ...
           $error_msg = '<div class="error">It seems like none of time table has been switched On goto <a href="listoftimetable.php">list of TimeTables</a> to switchOn the TimeTable.</div>';
